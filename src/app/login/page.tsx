              ...
              <title>Health Logo</title>
					...
					<div className="space-y-3 mb-4">
						<p className="text-xs text-gray-700">
							...
							may use your email address to send updates, ads, and offers. Opt
							out via{" "}
							<Link href="#" className="font-semibold">
								Privacy Policy
							</Link>
					...
					<div className="space-y-3">
						<button type="button" className="w-full flex items-center justify-center gap-2 h-12 border border-gray-300 rounded-md hover:bg-gray-50">
