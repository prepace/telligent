      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
          <div className="md:col-span-8">
            <h2 className="font-serif text-2xl font-bold mb-6 pb-2 border-b border-gray-200">Latest Stories</h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              {latestStories.map((data, index) => <LatestStoriesFormat data={data} key={index}/>)}
            </div>

            {/* Opinion Section */}
            <div className="mb-8">
              <h2 className="font-serif text-2xl font-bold mb-6 pb-2 border-b border-gray-200">Perspectives</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="border-b border-gray-200 pb-6">
                  ...
                  <p className="text-gray-700 mb-2">
                    Language matters in reducing stigma and encouraging people to seek help
                  </p>
                  <div className="text-sm text-gray-600">
                    <span className="font-medium">By Dr. Emily Rodriguez</span> • Clinical Psychologist
                  </div>
                </div>
                ...
                <div className="border-b border-gray-200 pb-6">
                  ...
                  <p className="text-gray-700 mb-2">
                    Normalizing preventative mental health care could reduce long-term disability and costs
                  </p>
                  <div className="text-sm text-gray-600">
                    <span className="font-medium">By Thomas Wright</span> • Workplace Wellness Expert
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Research Section */}
            <div>
              <h2 className="font-serif text-2xl font-bold mb-6 pb-2 border-b border-gray-200">Latest Research</h2>

              <div className="grid grid-cols-1 gap-6">
                {latestResearch.map((data, index) => <LatestResearchFormat data={data} key={index}/>)}
              </div>
            </div>
          </div>
...
const latestResearch = [
  {
    ...
    description: "Researchers find strong correlation between gut bacteria composition and mental health outcomes, suggesting new treatment avenues",
  ...
  },
  {
    ...
    title: "Exercise as Effective as Medication for Mild Depression, Study Finds",
    description: "Large-scale clinical trial shows regular physical activity can match antidepressants for symptom reduction in some patients",
...
const latestStories = [
  {
    ...
    description: "New research finds that mental health apps can be as effective as in-person therapy for mild to moderate cases",
    author: "Michael Chen",
    date: "5 hours ago"
  },
  {
    ...
    description: "Major employers are investing in employee wellness programs and seeing returns in productivity and retention",
  ...
  },
  {
    ...
    description: "New program teaches students coping skills and emotional regulation as part of standard education",
    author: "James Wilson",
    date: "Yesterday"
  },
  {
    ...
    description: "Bipartisan support grows for expanded access to mental health services as national crisis deepens",
