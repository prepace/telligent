...
// TODO: engagement histogram mock reserved for future charts (currently unused)
...
export default function UserAnalyticsPage() {
	...
	const totalActiveUsers =
		userData[timePeriod].reduce((sum, item) => sum + item.active, 0) /
		userData[timePeriod].length;
	const totalNewSignups = userData[timePeriod].reduce(
		(sum, item) => sum + item.newSignups,
		0,
	);
	const totalReturningUsers =
		userData[timePeriod].reduce((sum, item) => sum + item.returning, 0) /
		userData[timePeriod].length;
	...
	return (
		<div className="space-y-6">
            ...
            type="button"
				...
				<div
					className={`space-y-6 mt-6 ${activeTab !== "overview" ? "hidden" : ""}`}
				>
					...
					<div className="grid grid-cols-1 md:grid-cols-4 gap-6">
						<div className="bg-white p-6 rounded-lg shadow">
							...
							<div>
								<div className="text-2xl font-bold">
									{Math.round(totalActiveUsers).toLocaleString()}
								</div>
						...
						<div className="bg-white p-6 rounded-lg shadow">
							...
							<div>
								<div className="text-2xl font-bold">
									{Math.round(totalReturningUsers).toLocaleString()}
								</div>
								<p className="text-xs text-gray-500">
									{timePeriod === "daily"
										? "Daily average"
				...
				<div
					className={`space-y-6 mt-6 ${activeTab !== "engagement" ? "hidden" : ""}`}
				>
					...
					<div className="bg-white p-6 rounded-lg shadow">
						<div>
							...
							<p className="text-sm text-gray-500">
								When users are most active on your site
							</p>
						</div>
						<div>
							<div className="h-[300px]">
					...
					<div className="bg-white p-6 rounded-lg shadow">
						<div>
							...
							<p className="text-sm text-gray-500">
								Conversion path from visitors to subscribers
							</p>
						</div>
						<div>
							<div className="space-y-4">
				...
				<div
					className={`space-y-6 mt-6 ${activeTab !== "geography" ? "hidden" : ""}`}
				>
					<div className="bg-white p-6 rounded-lg shadow">
						<div className="flex flex-row items-center justify-between space-y-0 pb-2">
							<div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
						<div className="bg-white p-6 rounded-lg shadow">
							<div>
								...
								<p className="text-sm text-gray-500">
									User growth compared to previous period
								</p>
							</div>
							<div>
								<div className="h-[300px]">
				...
				{/* Content Tab Content */}
				<div
					className={`space-y-6 mt-6 ${activeTab !== "content" ? "hidden" : ""}`}
				>
					<div className="bg-white p-6 rounded-lg shadow">
						<div className="flex flex-row items-center justify-between space-y-0 pb-2">
							<div>
							...
							<div className="mt-6 border-t pt-4">
								...
								<div className="space-y-4">
									<div className="flex items-center">
										...
										<div>
											<h4 className="text-sm font-medium">
												Breaking News: Tech Innovation Revolutionizes Industry
											</h4>
											<p className="text-xs text-gray-500">
												Views: 45,230 | Avg. Time: 6.2 min
											</p>
										</div>
									</div>
									...
									<div className="flex items-center">
										...
										<div>
											<h4 className="text-sm font-medium">
												Political Analysis: Election Results and Implications
											</h4>
											<p className="text-xs text-gray-500">
												Views: 38,450 | Avg. Time: 7.5 min
											</p>
										</div>
									</div>
									...
									<div className="flex items-center">
										...
										<div>
											<h4 className="text-sm font-medium">
												Health Report: New Study Reveals Breakthrough
											</h4>
											<p className="text-xs text-gray-500">
												Views: 32,780 | Avg. Time: 5.8 min
											</p>
										</div>
									</div>
									...
									<div className="flex items-center">
										...
										<div>
											<h4 className="text-sm font-medium">
												Entertainment: Celebrity Interview Goes Viral
											</h4>
											<p className="text-xs text-gray-500">
												Views: 29,340 | Avg. Time: 4.3 min
											</p>
										</div>
									</div>
									...
									<div className="flex items-center">
										...
										<div>
											<h4 className="text-sm font-medium">
												Sports Update: Championship Final Results
											</h4>
											<p className="text-xs text-gray-500">
												Views: 27,890 | Avg. Time: 5.1 min
											</p>
										</div>
									</div>
								</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
						<div className="bg-white p-6 rounded-lg shadow">
							<div>
								...
								<p className="text-sm text-gray-500">
									When different content types are consumed
								</p>
							</div>
							<div>
								<div className="space-y-6">
						...
						<div className="bg-white p-6 rounded-lg shadow">
							<div>
								...
								<p className="text-sm text-gray-500">
									How users prefer to consume content
								</p>
							</div>
							<div>
								<div className="h-[300px]">
				...
				<div
					className={`space-y-6 mt-6 ${activeTab !== "retention" ? "hidden" : ""}`}
				>
					<div className="bg-white p-6 rounded-lg shadow">
						<div>
