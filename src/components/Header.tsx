		...
		<div className="border-b border-gray-400 sticky top-0 bg-white z-1">
			<div className="mx-auto px-4 py-2 flex items-center justify-center">
				<div className="flex items-center space-x-4 w-[40vw]">
					...
					<Link href="/resources" className="text-xs text-gray-600 hidden md:inline hover:underline">
						Resources
					</Link>
					<Link	href="/create-article" className="text-xs text-gray-600 hidden md:inline hover:underline">
						Create
					</Link>
					<Link	href="/my-articles"	className="text-xs text-gray-600 hidden md:inline hover:underline">
						My Articles
					</Link>
					<Link	href="/saved-articles" className="text-xs text-gray-600 hidden md:inline hover:underline">
						Saved
					</Link>
					<Link	href="/admin"	className="text-xs text-gray-600 hidden md:inline hover:underline">
						Admin
					</Link>
				</div>

				<Link href="/" className="w-20vw inline-block" aria-label="Home">
					<Image src={logo} alt="Telligent logo" className="h-[22px] w-auto" />
				</Link>
