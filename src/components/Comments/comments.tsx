	...
	const [comments, setComments] = useState<Comment[]>([
		{
			...
			date: "5 hours ago",
			content:
				"This article was incredibly insightful! I especially appreciated the detailed analysis of the topic.",
			likes: 5,
		},
		{
			id: "2",
			...
			replies: [
				{
					...
					date: "20 hours ago",
					content:
						"Could you elaborate on which nuances you feel were missed? I'd love to hear your thoughts!",
					likes: 1,
				},
			],
		},
		{
			...
			date: "2 days ago",
			content:
				"Thanks for sharing this information. It helped me understand the topic much better.",
			likes: 8,
		},
	]);
											...
											<div className="flex items-start gap-3">
												...
												<div className="flex-grow">
													<textarea
														...
														// autoFocus removed to satisfy lint rule
													></textarea>
